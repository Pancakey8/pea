...
enum class TokenType {
    ...
    // Keywords
    KW_Dim, KW_Let, KW_If, KW_Then, KW_Else, KW_EndIf, 
    KW_For, KW_To, KW_Step, KW_EndFor, KW_While, KW_Do, 
    KW_Loop, KW_Goto, KW_End, KW_As, KW_Mod, KW_And, KW_Or, KW_Not,
    // Operators
    Plus, Minus, Star, Slash, Caret, Backslash, 
    Eq, Neq, Less, Great, Lteq, Gteq, Amp,
